...
* Embedded systems:
  	- [Arduino Projects](https://github.com/uygarpolat/arduino-projects): An incomplete list of my Arduino microcontroller projects (most of the rest are lost to the ages, unfortunately).
